...
int main(int argc, char *argv[])
{
  ...
  if (argc < 4)
  {
    printf("Not enough arguments! Usage: ./Tree-generation trace_1 trace_2 omp_threads num_partitions(optional)\n");
    return 1;
  }
  ...
  if (argc > 5)
  {
    printf("Too many command line arguments! Usage: ./Tree-generation trace_1 trace_2 omp_threads num_partitions(optional)\n");
    return 1;
  }
  ...
  stripe_join_partitoin_dim0_sweep_dim1_parallel(stripe_results_partitoin_dim0_sweep_dim1, &R, &S, l, r, numPartitions);
  ...
  stripe_join_partitoin_dim1_sweep_dim0_parallel(stripe_results_partitoin_dim1_sweep_dim0, &R, &S, b, t, numPartitions);
