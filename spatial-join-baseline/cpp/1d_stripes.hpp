...
void stripe_join_partitoin_dim0_sweep_dim1(std::vector<std::pair<MBR *, MBR *>> &results, std::vector<MBR *> *R, std::vector<MBR *> *S,
...
void stripe_join_partitoin_dim1_sweep_dim0(std::vector<std::pair<MBR *, MBR *>> &results, std::vector<MBR *> *R, std::vector<MBR *> *S,
