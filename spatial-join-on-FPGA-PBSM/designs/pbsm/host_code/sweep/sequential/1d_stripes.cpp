...
//        numPartitions = 100;
    ...
    run_result_t res_1 = stripe_join_partitoin_dim0_sweep_dim1(stripe_results_partitoin_dim0_sweep_dim1, &R, &S, l, r,
                                                        numPartitions);
    ...
    run_result_t res_2 = stripe_join_partitoin_dim1_sweep_dim0(stripe_results_partitoin_dim1_sweep_dim0, &R, &S, b, t,
                                                        numPartitions);
