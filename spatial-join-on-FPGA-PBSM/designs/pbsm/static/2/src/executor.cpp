...
#pragma HLS stream variable=FIN_schedule_stream_A depth=64

    hls::stream<bool> FIN_schedule_stream_B[N_JOIN_UNITS];
#pragma HLS stream variable=FIN_schedule_stream_B depth=64

    hls::stream<bool> FIN_schedule_stream_join[N_JOIN_UNITS];
#pragma HLS stream variable=FIN_schedule_stream_join depth=64
